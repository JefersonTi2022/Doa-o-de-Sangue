        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <h4><b>Sangue disponível por grupo em litros</b></h4>
                    <div class="row">
                        <?php 
                ...
                success:function(resp){
                    if(resp){
                        ...
                        if(resp.status == 1){
                            ...
                            alert_toast("ID de rastreamento desconhecido.",'danger');
                            end_load();
                        }
                    }
                }
