...
<div class="container-fluid">
	<form action="" id="manage-request">
		...
		<div class="form-group">
			<label for="" class="control-label">Nome Completo do Paciente</label>
		...
		<div class="form-group">
			<label for="" class="control-label">Volume disponível (L)</label>
		...
		<div class="form-group">
			<label for="" class="control-label">Nome do Médico(a)</label>
...
<script>
	...
	$('#manage-request').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Dados salvos com sucesso.",'Sucesso')
						setTimeout(function(){
							location.reload()
						},1000)
				}
